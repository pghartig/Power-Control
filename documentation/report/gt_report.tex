...
It is useful to first review relevant tools for solving such games as these tools will provide steps to take in reaching the goal of finding pure strategy Nash Equilibrium the do not require system overhead to arrive at. 

\begin{enumerate}
\item The "n-concave game".
\begin{itemize}
