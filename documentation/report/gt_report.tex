...
In particular, the Dual Ascent method described in \cite{boyd2011distributed} will be used. 
...
In the following algorithms and simulation results the utility function $U_{\text{fi}}(\gamma_{\text{fi}}) = log(1+\gamma_{\text{fi}})$.
