...
\begin{subequations}
	...
	\begin{align}
        ...
        \label{power_const}\\
        & \langle \mathbf{h_{f,j}}\mathbf{u_{f,i}} \rangle =0\ \; \forall j \in \{1... K_f\}				\backslash i &\forall i \in \{1 ... K_f\}\; \forall f \in \{1 ... F\} \label{zf_const}
	\end{align}
	\end{subequations}

is a normalized Nash Equilibrium.
As it has been above, this Nash Equilibrium to this problem exists, and is unique. Therefore, the solution to \eqref{potential_game} exists and is unqiue.
\\
