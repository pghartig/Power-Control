...
No further assumptions can be made, however, wrt increasing or decreasing.
\item
As $U_f(\gamma_{\mathrm{f,i}}) $ is strictly concave (non-decreasing?) by definition and the argument is a positive semi-definite quadratic term.
\end{itemize}
